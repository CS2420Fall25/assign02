...
public class CS2420Class {
	...
	/**
	 * Adds an assignment, exam, lab, quiz, or poll score for the CS 2420 student
	 * with the given uNID.
	 * 
	 * NOTE: If the category string is not one of "assignment", "exam", "lab",
	 * "quiz", or "poll", or if no student with the uNID exists in the collection,
	 ...
	 * scores, separated by blank spaces -- sixth line: poll scores, separated by
	 * blank spaces -- seventh line ... : repeat of lines 1-6 for another student
	 * 
